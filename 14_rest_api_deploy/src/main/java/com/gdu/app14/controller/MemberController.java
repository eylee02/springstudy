...
public class MemberController {
  ...
  // 회원 정보 삭제요청
  @RequestMapping(value="/member/{mNo}", method=RequestMethod.DELETE, produces="application/json")
  public Map<String, Object> deleteMember(@PathVariable(value="mNo") int memberNo) {
