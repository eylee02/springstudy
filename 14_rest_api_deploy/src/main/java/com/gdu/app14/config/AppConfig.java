...
public class AppConfig {
  ...
  @Bean
  public HikariDataSource hikariDtaSource() {
  ...
  public SqlSessionFactory sqlSessionFactory() throws Exception {
    ...
    sqlSessionFactoryBean.setDataSource(hikariDtaSource());
  ...
  // TransactionMannager : 트랜잭션을 처리하는 스프링 인터페이스
  @Bean
  public TransactionManager transactionManager() {
    return new DataSourceTransactionManager(hikariDtaSource());
  }
