 ...
 * 4. 생성된 비밀번호를 복사해서 email.properties 파일에 붙여넣기한다(공백없이)
 */
...
public class MyJavaMailUtils {
  ...
  public void sendJavaMail(String to, String subject, String content) {
    ...
    try {
      ...
      properties.put("mail.smtp.starttls.enable", env.getProperty("spring.mail.properties.mail.smtp.strattls.enable"));
