...
-- 휴면 사용자 테이블 (1년 이상 로그인 기록이 없으면 휴면처리) 
...
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 'user1@naver.com', STANDARD_HASH('1111', 'SHA256'), '사용자1', 'M', '01011111111', '11111', '디지털로', '가산동', '101동 101호', 0, TO_DATE('20231001', 'YYYYMMDD'), TO_DATE('20221001','YYYYMMDD'));
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 'user2@naver.com', STANDARD_HASH('2222', 'SHA256'), '사용자2', 'F', '01022222222', '22222', '디지털로', '가산동', '201동 101호', 0, TO_DATE('20230801', 'YYYYMMDD'), TO_DATE('20221001','YYYYMMDD'));
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 'user3@naver.com', STANDARD_HASH('3333', 'SHA256'), '사용자3', 'F', '01033333333', '33333', '디지털로', '가산동', '101동 101호', 0, TO_DATE('20230601', 'YYYYMMDD'), TO_DATE('20221001','YYYYMMDD'));

INSERT INTO ACCESS_T VALUES('user1@naver.com', TO_DATE('20231018', 'YYYYMMDD'));  -- 정상회원 (user1)
INSERT INTO ACCESS_T VALUES('user2@naver.com', TO_DATE('20220201', 'YYYYMMDD'));  -- 휴면회원 (user2)
...
-- 5. 탈퇴 할 때
INSERT INTO LEAVE_USER_T VALUES('user1@naver.com', TO_DATE('20221001', 'YYYYMMDD'), SYSDATE);
