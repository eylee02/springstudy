...
public class MyController03 {
   ...
   *    1) Java EE 표준 방식이다.
   *    2) 파라미터뿐만 아니라 HttpSession, String contextPath 와 같은 정보도 꺼낼 수 있다. 
   */
  ...
  public String blogDetail(HttpServletRequest request, Model model) {
    ...
    String blogNo = request.getParameter("blogNo"); // 요청은 request로
    model.addAttribute("blogNo", blogNo);           // forward할 정보는 model에 저장
